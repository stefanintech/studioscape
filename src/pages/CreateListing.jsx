    ...
    <div className="profile">
        ...
        <main>
            <form onSubmit={onSubmit}>
                ...
                <div className='formButtons'>
                    <button
                    className={audioVisualEquipment ? 'formButtonActive' : 'formButton'}
                    type='button'
                ...
                <div className='formButtons'>
                    <button
                    className={kitchenCateringArea ? 'formButtonActive' : 'formButton'}
                    type='button'
                ...
                <div className='formButtons'>
                    <button
                    className={photographyArtEquipment ? 'formButtonActive' : 'formButton'}
                    type='button'
                ...
                <div className='formButtons'>
                    <button
                    className={wheelchairAccessible ? 'formButtonActive' : 'formButton'}
                    type='button'
